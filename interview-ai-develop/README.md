...
## Live Demo
**Application URL:**  **[http://10.230.100.222:23340/](http://10.230.100.222:23340/)**
...
1.  **Analyzes Intent:** Identifies if a question is a standard behavioral prompt or a strategic failure/obstacle question.
2.  **Selects Framework:** Automatically routes to STAR (for standard stories) or SOAR (for strategic challenges).
3.  **Generates Structure:** Streams a token-by-token sample response to guide the user.
